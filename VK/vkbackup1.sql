...
--
-- Table structure for table `comment_objects`
--
...
--
-- Dumping data for table `comment_objects`
--

LOCK TABLES `comment_objects` WRITE;
/*!40000 ALTER TABLE `comment_objects` DISABLE KEYS */;
/*!40000 ALTER TABLE `comment_objects` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `communities` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `object_id` int unsigned NOT NULL COMMENT 'Обьект группы',
...
--
-- Table structure for table `liked_objects`
--
...
--
-- Dumping data for table `liked_objects`
--

LOCK TABLES `liked_objects` WRITE;
/*!40000 ALTER TABLE `liked_objects` DISABLE KEYS */;
/*!40000 ALTER TABLE `liked_objects` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `messages` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'id строки',
...
LOCK TABLES `tag_objects` WRITE;
/*!40000 ALTER TABLE `tag_objects` DISABLE KEYS */;
/*!40000 ALTER TABLE `tag_objects` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-12-26 16:46:55
